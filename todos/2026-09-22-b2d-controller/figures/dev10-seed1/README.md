...
```bash
/data/envs/carla/bin/python scripts/b2d_controller_plot.py --development /data/runs/b2d/controller/development3 --campaign /data/runs/b2d/controller/confirmation --out /data/runs/b2d/controller/figures-seed1-final --route-id 26966 --label 'Dev10 seed 1'
```
