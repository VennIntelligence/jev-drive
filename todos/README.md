...
- [2026-09-26-night-queue-3.md](2026-09-26-night-queue-3.md) — 夜间队列 3：P6 上读全部考生（谁会绕、谁只会停，Q1）、在 openpilot 冻结特征上用配对差分激发绕行（Q2）、P6 v1 扩容与 recovery 题（Q3）、真实非 hazard 帧上的 Δ 零约束与 NAVSIM 协议兼容检查（Q4）、六族 hack 核查（Q5）、主表口径统一与 V-JEPA 2 后续（Q6）
