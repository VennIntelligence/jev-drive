...
- [2026-09-23 W2：TFv6 + 我们的控制器](2026-09-23-tfv6-controller/report.md)：TFv6 waypoint 交给 production 控制器与作者 waypoint PID 的四臂预注册闭环（[协议](2026-09-23-tfv6-controller/protocol.md)）；控制器主效应 C−B 未检出，route+speed 表示比 waypoint 高约 14 DS。
