...
- **失败项全部是动作/舒适性保护**：emitted steer-rate P95 相对增幅超过 20% 的有 8 个窗（24240 +39%，以及 7 个 held-out 窗中的 6 个，+22–47%）；横向加速度 P95 相对增幅超过 10% 的有 4 个窗（24240 +10.5%，S1 +23%，S2 +25%，17569 +36%）。这些增幅在 truth-pose ceiling 臂之间同样出现（slipack-truth 对 prod-truth），所以是控制律本身带来的，不是定位噪声。
