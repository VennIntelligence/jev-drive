...
| [research/capability-vs-leaderboard.md](research/capability-vs-leaderboard.md) | direction skeleton (2026-09-24): driving ability split into a routine (R) and an emergent-reaction (E) layer, leaderboard score vs ability, the four measurements (hack audit, zoo in CARLA, R layer, P5 v1 E layer) and candidate extraction methods |
