...
| Benchmark | 角色 | 说明 |
|---|---|---|
| Waymo E2E | 主 | 有公开 leaderboard，有 FROST-Drive 这个 frozen-vision 的直接对手。**val 的 preference trajectory 分数几乎全是 -1，本地算不了 RFS**，开发只能看 ADE/minADE，RFS 要靠提交 test（每 30 天 6 次） |
