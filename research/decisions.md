...
## 23. P2 读出阶梯：pooled 单帧之外，readout 和输入各松一格（**(b)(c)(d) 已测，(e) 待填**）
...
待跑（gated residual head，第 25 条的无配对对照；读法已在 todo 里写死）。

**状态**：(b)(c)(d) **已确认**（限定在半 val 预演、这批冻结特征、以及 (c)(d) 那条子集样本量的限定上）；(e) 待跑。
