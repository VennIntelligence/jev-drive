...
async def new_submission(
    ...
    try:
        ...
        print(f"[{today}] Request Exception: {e}")        # for the host to check detailed error in the space log

        if e.response.status_code == 404:
            return {"response": "Repository not found. Please ensure that the repository submitted is a model repository and that your current account has access to it."}
