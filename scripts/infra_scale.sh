...
case $step in
    ...
    t03-alp)  scale t03-alp 25378 4 1,2,4,6,8,12,16 1200 "$@" -- "${ALPS[@]}" ;;
    t13-alp)  scale t13-alp 3561 4 1,4,8 1200 "$@" -- "${ALPS[@]}" ;;
    t13-alp-lights) scale t13-alp-lights 3561 4 1,4,8 1200 "$@" -- "${ALPS[@]}" --cache-lights ;;
