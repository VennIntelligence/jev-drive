# Vendored verbatim (below the marker) from Bench2DriveZoo, branch tcp/admlp, commit 8a08b07 (identical up to
# whitespace on branch uniad/vad 498c1f7), team_code/planner.py: the RoutePlanner(4.0, 50.0) whose next route node
# the Zoo agents pass to PIDController.control_pid as `target`. Only this header is added; do not edit below.
# ---- vendored ----
import os
