...
| [hugsim.md](hugsim.md) | you need the HUGSIM closed-loop benchmark: data, Blackwell install, running a scenario, the agent interface, HD-Score, the controller heading defect |
